...
const getUsersData = async () => {
  ...
  return [
    { name: 'Test 1', email: 'test1@google.com', password: hashedPassword },
    { name: 'Test 2', email: 'test2@google.com', password: hashedPassword },
    { name: 'Test 3', email: 'test3@google.com', password: hashedPassword },
    { name: 'Test 4', email: 'test4@google.com', password: hashedPassword },
    { name: 'Test 5', email: 'test5@google.com', password: hashedPassword },
    { name: 'Test 6', email: 'test6@google.com', password: hashedPassword },
  ];
};
